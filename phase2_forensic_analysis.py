...
if __name__=='__main__':
    ...
    os.makedirs('/root/nestquant/logs/mr_phase2',exist_ok=True)
    with open('/root/nestquant/logs/mr_phase2_metrics.json','w') as f:
        json.dump(R,f,indent=2,default=str)
    print(f"\n  Saved /root/nestquant/logs/mr_phase2_metrics.json")
