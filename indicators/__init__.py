"""Backward-compatible re-export. Canonical location: platform/tooling/indicators"""
...
__all__ = [
    "calculate_atr", "calculate_adx", "ema", "pip_size",
    "swing_high_series", "swing_low_series",
    "resample_to_timeframe", "is_active_session",
]
