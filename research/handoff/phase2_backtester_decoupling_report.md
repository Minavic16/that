...
`adc898c` on `research/strategy-2` — "feat(research): extract strategy-agnostic execution core (Phase 2 backtester decoupling)" (7 files, +743/−199). Not pushed. Not merged. master/production untouched.
